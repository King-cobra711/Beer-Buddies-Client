  ...
  useEffect(() => {
    ...
    if (typeof PlayerID !== "undefined") {
      ...
      async function fetchAPI() {
        setLoaded(false);
        const request = await fetch(process.env.REACT_APP_URL + "/userScores", {
          method: "POST",
          headers: {
            "Content-type": "application/json",
          },
            ...
            >
              <Mui.Grid item xs={12}>
                <Formik
                  ...
                  onSubmit={(fields) => {
                    console.log(playerID);
                    fetch(process.env.REACT_APP_URL + "/UpdateBiography", {
                      method: "POST",
                      headers: {
                        "Content-type": "application/json",
                      },
          ...
          <div className={classes.modalMessageTheme}>
            ...
            >
              <Mui.Grid item xs={12}>
                <form
                  onSubmit={() => {
                    fetch(process.env.REACT_APP_URL + "/UpdateTheme", {
                      method: "POST",
                      headers: {
                        "Content-type": "application/json",
                      },
          ...
          <div className={classes.modalMessageTheme}>
            ...
            >
              <Mui.Grid item xs={12}>
                <form
                  onSubmit={() => {
                    fetch(process.env.REACT_APP_URL + "/UpdatePic", {
                      method: "POST",
                      headers: {
                        "Content-type": "application/json",
                      },
